...
public class User 
{
	...
	public String toString() {
		return "User [userId=" + userId + ", userName=" + userName + ", userPassword=" + userPassword + ", userMobile="
				+ userMobile + ", userAddedDate=" + userAddedDate + ", getUserId()=" + getUserId() + ", getUserName()="
				+ getUserName() + ", getUserPassword()=" + getUserPassword() + ", getUserMobile()=" + getUserMobile()
				+ ", getUserAddedDate()=" + getUserAddedDate() + ", getClass()=" + getClass() + ", hashCode()="
