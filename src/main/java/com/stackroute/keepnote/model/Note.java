...
public class Note 
{
	...
	int noteId;
	String noteTitle, noteContent, noteStatus, createdBy;
	Date noteCreatedAt;
	...
	public Note(int noteId, String noteTitle, String noteContent, String noteStatus, 
			Date noteCreatedAt, Category category, Reminder reminder, String createdBy) {
		super();
		this.noteId = noteId;
		this.noteTitle = noteTitle;
		this.noteContent = noteContent;
	...
	public String toString() 
	{
		return "Note [noteId=" + noteId + ", noteTitle=" + noteTitle + ", noteContent=" + noteContent + ", noteStatus="
				+ noteStatus + ", createdBy=" + createdBy + ", noteCreatedAt=" + noteCreatedAt + ", category="
