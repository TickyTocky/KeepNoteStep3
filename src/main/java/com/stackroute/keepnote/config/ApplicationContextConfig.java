...
public class ApplicationContextConfig 
{
	...
	public DataSource getDataSource() 
	{
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/keepnotestep3");
		dataSource.setUsername("root");
		dataSource.setPassword("$54c9$%B");
		return dataSource;
	}
	...
	public LocalSessionFactoryBean getSessionFactory(DataSource dataSource) throws IOException {
		...
		sessionFactoryBean.setAnnotatedClasses(Reminder.class);
		sessionFactoryBean.setAnnotatedClasses(Category.class);
